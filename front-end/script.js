      ...
      for (let i = 0; i < data.length; i++) {
        ...
        `<div style="width: 18rem; height: 7rem; background-color: #dd4489b1"
            ...
            <div class="buttons" style = "margin-top: -4rem">
              <button class="btn edit-button" onclick="showText('${id}')"><img src="./images/edit.png" style="width: 1rem; height: 1rem"></button>
              <button class="btn delete-button" style="background-color: #7209b5" onclick="remove('${id}')"><img src="./images/delete.png" style="width: 1rem; height: 1.4rem"></button>
            </div>
        </div>`;
      }
    });
...
let add = () => {
  ...
  .then((data) => {
    ...
    `<div style="width: 18rem; background-color: #dd4489b1"
        ...
        <div class="buttons" style = "margin-top: -4rem">
          <button class="btn" onclick="showText('${id}')"><img src="./images/edit.png" style="width: 1rem; height: 1rem"></button>
          <button class="btn" onclick="remove('${id}')" style="background-color: #7209b7">Delete</button>
        </div>
    </div>`;
